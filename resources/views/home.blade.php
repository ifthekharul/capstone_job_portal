@extends ('layouts/app')
@section('main')
<section class="section-0 lazy d-flex bg-image-style dark align-items-center "  data-bg="assets/images/banner5.jpg">
    <div class="container">
        <div class="row">
...
<section class="section-1 py-5 "> 
    <div class="container">
        <div class="card border-0 shadow p-5">
            <form action="{{ route("job_details") }}" method="get">
            <div class="row">
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    <a href="{{ route("job_details").'?category='. $category->id }}"><h4 class="pb-2">{{ $category->name}}</h4></a>
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('jobDetailpage',$featuredJob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{ \Illuminate\Support\Str::words($latestJob->description, 5)}}</p>
                                    <div class="bg-light p-3 border">
                                        <p class="mb-0">
                                            <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('jobDetailpage',$latestJob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
