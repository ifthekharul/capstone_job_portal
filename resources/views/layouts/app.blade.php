...
<head>
	...
	<title>AmarJobs | A Online Job portal </title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home')}}">AmarJobs</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item">
						<a class="nav-link" aria-current="page" href="{{ route('job_details')}}">Find Jobs</a>
					</li>										
				</ul>
				@if(!Auth::check())
      ...
      <div class="modal-body">
        <form action="" name="profilePicForm" id="profilePicForm" method="post">
            <div class="mb-3">
				...
				<p class="text-danger" id="image-error" class="image-error"></p>
            </div>
